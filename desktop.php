...
<div class="container-fluid" style="margin-top: 70px">
  <div class="row">
    <div class="col-12">
      <h1 style="text-align: center;">DESKTOPS</h1>
      <hr>
...
<div class="card">
  <div class="card-body">
    ...
    <img src="images/71.png" alt="" style="width: 100%; height: 100%;">
    
  </div>
</div>
<h1 style="margin-top: 30px"></h1>
<h3 style="background-color: black;color: white;font-size: 20px;padding: 30px;">DELL VOSTRO 3888 MINI TOWER BTX BASE (INTEL CORE I5)
DESKTOP</h3>
<h3 style="background-color: black;color: white;font-size: 20px;padding: 30px;">රු299,000.00</h3>
</div>

<div class="col-sm-3">
<div class="card">
  <div class="card-body" style="background-color: white">
    <img src="images/72.png" alt="" style="width: 100%; height: 100%;">
  </div>
</div>
<h1 style="margin-top: 30px"></h1>
<h3 style="background-color: black;color: white;font-size: 20px;padding: 30px;">DELL VOSTRO 3910 DESKTOP PC (INTEL CORE I3)
DESKTOP</h3>
<h3 style="background-color: black;color: white;font-size: 20px;padding: 30px;">රු246,000.00</h3>
</div>
...
<div class="card">
  <div class="card-body">
    <img src="images/73.png" alt="" style="width: 100%; height: 100%;">
  </div>
</div>
<h1 style="margin-top: 30px"></h1>
<h3 style="background-color: black;color: white;font-size: 20px;padding: 30px;">DELL VOSTRO 3910 DESKTOP PC (INTEL CORE I5)
DESKTOP</h3>
<h3 style="background-color: black;color: white;font-size: 20px;padding: 30px;">රු295,000.00</h3>
</div>

<div class="col-sm-3">
<div class="card">
  <div class="card-body">
    <img src="images/74.webp" alt="" style="width: 100%; height: 100%;">
  </div>
</div>
<h1 style="margin-top: 30px"></h1>
<h3 style="background-color: black;color: white;font-size: 20px;padding: 30px;">LENOVO THINK CENTER NEO N50T DESKTOP PC (INTEL CORE I3)
DESKTOP</h3>
<h3 style="background-color: black;color: white;font-size: 20px;padding: 30px;">රු214,500.00</h3>
</div>
