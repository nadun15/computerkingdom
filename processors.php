...
<div class="container-fluid" style="margin-top: 70px">
  <div class="row">
    <div class="col-12">
      <h1 style="text-align: center;">PROCESSORS</h1>
      <hr>
...
<div class="card">
  <div class="card-body">
    ...
    <img src="images/75.png" alt="" style="width: 100%; height: 100%;">
    
  </div>
</div>
<h3 style="background-color: black;color: white;font-size: 20px;padding: 30px;">AMD RYZEN 5-3600 CPU
PROCESSORS</h3>
<h3 style="background-color: black;color: white;font-size: 20px;padding: 30px;">රු44,000.00</h3>
</div>

<div class="col-sm-3">
<div class="card">
  <div class="card-body" style="background-color: white">
    <img src="images/76.png" alt="" style="width: 100%; height: 100%;">
  </div>
</div>
<h1 style="margin-top: 30px"></h1>
<h3 style="background-color: black;color: white;font-size: 20px;padding: 30px;">AMD RYZEN 7-5700G CPU
PROCESSORS</h3>
<h3 style="background-color: black;color: white;font-size: 20px;padding: 30px;">රු67,000.00</h3>
</div>
...
<div class="card">
  <div class="card-body">
    <img src="images/77.png" alt="" style="width: 100%; height: 100%;">
  </div>
</div>
<h1 style="margin-top: 30px"></h1>
<h3 style="background-color: black;color: white;font-size: 20px;padding: 30px;">INTEL CORE i5-11400F CPU
PROCESSORS</h3>
<h3 style="background-color: black;color: white;font-size: 20px;padding: 30px;">රු47,000.00</h3>
</div>

<div class="col-sm-3">
<div class="card">
  <div class="card-body">
    <img src="images/78.png" alt="" style="width: 100%; height: 100%;">
  </div>
</div>
<h1 style="margin-top: 30px"></h1>
<h3 style="background-color: black;color: white;font-size: 20px;padding: 30px;">INTEL CORE i7-12700 CPU
PROCESSORS</h3>
<h3 style="background-color: black;color: white;font-size: 20px;padding: 30px;">රු136,000.00</h3>
</div>
...
<div class="card">
  <div class="card-body">
    ...
    <img src="images/79.png" alt="" style="width: 100%; height: 100%;">
    
  </div>
</div>
<h1 style="margin-top: 30px"></h1>
<h3 style="background-color: black;color: white;font-size: 20px;padding: 30px;">INTEL CORE i9-12700K CPU
PROCESSORS</h3>
<h3 style="background-color: black;color: white;font-size: 20px;padding: 30px;">රු162,000.00</h3>
</div>

<div class="col-sm-3">
<div class="card">
  <div class="card-body">
    <img src="images/80.png" alt="" style="width: 100%; height: 100%;">
  </div>
</div>
<h1 style="margin-top: 30px"></h1>
<h3 style="background-color: black;color: white;font-size: 20px;padding: 30px;">INTEL CORE i9-12900K CPU
PROCESSORS</h3>
<h3 style="background-color: black;color: white;font-size: 20px;padding: 30px;">රු210,000.00</h3>
</div>
...
<div class="card">
  <div class="card-body">
    <img src="images/81.png" alt="" style="width: 100%; height: 100%;">
  </div>
</div>
<h1 style="margin-top: 30px"></h1>
<h3 style="background-color: black;color: white;font-size: 20px;padding: 30px;">INTEL CORE™ I5-12400 CPU
PROCESSORS</h3>
<h3 style="background-color: black;color: white;font-size: 20px;padding: 30px;">රු67,000.00</h3>
</div>
...
<div class="card">
  <div class="card-body">
    <img src="images/82.png" alt="" style="width: 100%; height: 100%;">
  </div>
</div>
<h1 style="margin-top: 30px"></h1>
<h3 style="background-color: black;color: white;font-size: 20px;padding: 30px;">INTEL CORE™ I5-12400F CPU
PROCESSORS</h3>
<h3 style="background-color: black;color: white;font-size: 20px;padding: 30px;">රු65,000.00</h3>
...
<div class="card">
  <div class="card-body">
    ...
    <img src="images/83.png" alt="" style="width: 100%; height: 100%;">
    
  </div>
</div>
<h1 style="margin-top: 30px"></h1>
<h3 style="background-color: black;color: white;font-size: 20px;padding: 30px;">INTEL PENTIUM DUAL CORE G6400 CPU
PROCESSORS</h3>
<h3 style="background-color: black;color: white;font-size: 20px;padding: 30px;">රු25,950.00</h3>
</div>
...
<div class="card">
  <div class="card-body">
    <img src="images/84.png" alt="" style="width: 100%; height: 100%;">
  </div>
</div>
<h1 style="margin-top: 30px"></h1>
<h3 style="background-color: black;color: white;font-size: 20px;padding: 30px;">PROCESSOR AMD 3-3300X CPU
PROCESSORS</h3>
<h3 style="background-color: black;color: white;font-size: 20px;padding: 30px;">රු41,650.00</h3>
</div>
