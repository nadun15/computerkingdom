...
if(isset($_POST['submit']))
{
	...
	$email=$_POST['email'];
	$gender=$_POST['gender'];
	$result="INSERT INTO registrationweb(contact,name,address,email,gender,date) VALUES('$contact','$name','$address','$email','$gender', now())";
...
<body style="background-color: ">
	...
	<div class="col-sm-4">
	<div class="card" style="margin-top: 150px; background-color:black;">
		<div class="card-body">
			<center><img src="images/logo.12.png" style="width: 100px; height:100px;background-color: red"></center>
			<center><h2 style="color: white">Registration</h2></center><hr>
...
<!-- 				<option value="software development">PROCESSORS</option>
			    <option value="MS office">MOTHERBOARDS</option>			    <option value="full stack web developer">RAM (MEMORY) </option>
			    <option value="full stack web developer">GRAPHIC CARDS</option>
			    <option value="full stack web developer">UPS</option>
			    <option value="full stack web developer">POWER SUPPLY</option>
			    <option value="full stack web developer">COOLER</option> -->
			</select>
