...
<div class="card">
  <div class="card-body">
    ...
    <img src="images/122.jpg" alt="" style="width: 100%; height: 100%;">
    
  </div>
</div>
<h1 style="margin-top: 30px"></h1>

<h3 style="background-color: black;color: white;font-size: 20px;padding: 30px;">EMARK GM4 MINI DC UPS</h3>
<h3 style="background-color: black;color: white;font-size: 20px;padding: 30px;">රු10,900.00</h3>
</div>
...
<h1 style="margin-top: 30px"></h1>
<h3 style="background-color: black;color: white;font-size: 20px;padding: 30px;">KSTAR LINE INTERACTIVE UA120 (1200VA) UPS</h3>
<h3 style="background-color: black;color: white;font-size: 20px;padding: 30px;">රු25,700.00
</h3>
</div>
...
<div class="card">
  <div class="card-body">
    <img src="images/124.jpg" alt="" style="width: 100%; height: 100%;">
  </div>
</div>
<h1 style="margin-top: 30px"></h1>
<h3 style="background-color: black;color: white;font-size: 20px;padding: 30px;">UPS KSTAR LINE INTERACTIVE UA60 (600VA)</h3>
<h3 style="background-color: black;color: white;font-size: 20px;padding: 30px;">රු11,700.00</h3>
</div>

<div class="col-sm-3">
<div class="card">
  <div class="card-body">
    <img src="images/125.png" alt="" style="width: 100%; height: 100%;">
  </div>
</div>
<h1 style="margin-top: 30px"></h1>
<h3 style="background-color: black;color: white;font-size: 20px;padding: 30px;">VERTIV LINE INTERACTIVE LIBERT ITON CX650 (650VA) UPS</h3>
<h3 style="background-color: black;color: white;font-size: 20px;padding: 30px;">රු15,500.00</h3>
</div>
